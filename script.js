...
document.addEventListener('DOMContentLoaded', () => {
    ...
    aiChatToggle.addEventListener('click', () => toggleChat(true));
    if (chatFab) chatFab.addEventListener('click', () => toggleChat(true));
    closeChatbotBtn.addEventListener('click', () => toggleChat(false));
    ...
    function addMessage(text, sender) {
        ...
        if (sender === 'bot') {
            ...
            // Treat user messages as plain text
    ...
    async function sendMessage() {
        ...
        typing.className = 'message bot-message typing-indicator-container';
        ...
        try {
            ...
            // Artificial delay to make it feel more "conversational"
            setTimeout(() => {
                addMessage(data.reply, 'bot');
            }, 300);
        } catch (e) {
            typing.remove();
            addMessage("Sorry, I can't connect to the AI engine right now. Please check if the server is running.", 'bot');
        }
    }
