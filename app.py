...
# --- CONFIGURATION ---
WEATHERAPI_KEY = os.environ.get("WEATHERAPI_KEY", "bf9065b52e48400984c174017252609")
DEFAULT_LOCATION = os.environ.get("DEFAULT_LOCATION", "Tiruchirappalli")

# --- EMAIL CONFIGURATION (Gmail SMTP) ---
# Set your Gmail address and App Password below or via environment variables.
SENDER_EMAIL    = os.environ.get("SENDER_EMAIL", "mineguard.alerts@gmail.com")
...
OLLAMA_API_KEY = os.environ.get("OLLAMA_API_KEY", "80bdea60af104d6caa8ac112bd58f966.fpihJUZDBwYYJfPd50a2U4VH")
...
Provide a concise, expert answer relevant to mine safety. Use Markdown formatting (bold, lists, or tables) to make your response clear and structured:"""
    ...
    try:
        ...
        reply = data.get('message', {}).get('content') or data.get('choices', [{}])[0].get('message', {}).get('content', str(data))
        return jsonify({"reply": reply})
    except Exception as e:
        print(f"[AI ERROR] {e}")
        return jsonify({"reply": f"Ollama Cloud Assistant is currently unavailable. Error: {e}"}), 500
